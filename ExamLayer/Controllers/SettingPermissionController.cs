...
namespace ExamLayer.Controllers
{
    ...
    public class SettingPermissionController : BaseController
    {
        private readonly ISettingPermissionService _IndexBusinessMetaService;
        public SettingPermissionController(ISettingPermissionService IndexBusinessMetaService)
        {
